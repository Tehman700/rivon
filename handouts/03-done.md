...
| CHN-13 | ✅ | *New feature, not in the original list.* Self-serve connection, the ManyChat model: Facebook Login for Business for Pages and Instagram, WhatsApp Embedded Signup for WhatsApp. Checks the permissions actually granted, subscribes each account before storing it, and explains anything it had to leave out. Verified in production for Messenger and Instagram on 25 Sep. | `f930aa4`, `ab865b4`, `946b757` |
